...
export const greaterOrEqualValidator = (threshold: number): ParamValidator<number> =>
  (param: number) => param >= threshold;

export const lessThanValidator = (threshold: number): ParamValidator<number> =>
  (param: number) => param < threshold;

export const lessOrEqualValidator = (threshold: number): ParamValidator<number> =>
  (param: number) => param <= threshold;

export const equalsStrictValidator = (threshold: any): ParamValidator<number> =>
  (param: number) => param == threshold;
